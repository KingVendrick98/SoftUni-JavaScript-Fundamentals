function solve(input) {
    ...
    for (let line of input) {
        ...
        if (!players.hasOwnProperty(name)) {
           ...
           players[name] = uniqueCards;
            ...
            // players[name] = players[name].concat(uniqueCards);
    ...
    function calculateProduct(power, type) {
        let cardPowerMultiplyer = cardPowers[power];
        let cardTypeMultiplyer = cardTypes[type];

        return cardPowerMultiplyer * cardTypeMultiplyer;
    }
}
solve([
